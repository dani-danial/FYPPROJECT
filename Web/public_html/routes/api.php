...
// ===========================================
Route::group(['middleware' => ['auth:sanctum', 'check.banned']], function () {
    ...
    Route::post('/groups/join', [GroupController::class, 'apiJoin']);
    Route::post('/groups/leave', [GroupController::class, 'apiLeave']);
    Route::get('/groups/{group}/leaderboard', [GroupController::class, 'leaderboard']);
    ...
    // --- POSTS ---
    Route::get('/posts/feed', [PostController::class, 'homeFeed']);
